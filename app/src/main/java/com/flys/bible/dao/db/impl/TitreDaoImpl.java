...
public class TitreDaoImpl extends GenericDaoImpl<Titre, Long> implements TitreDao {

    DatabaseHelper<Titre, Long> databaseHelper;

    @Override
    public Dao<Titre, Long> getDao() {
        ...
        try {
            return (Dao<Titre, Long>) databaseHelper.getDao(getEntityClassManaged());
    ...
    @Override
    public Class<Titre> getEntityClassManaged() {
        return Titre.class;
    }
}
